...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        //STARTS FIREBASE REFERENCE

        mDatabase = FirebaseDatabase.getInstance().getReference().child("RestaurantUser").child("RestaurantMenu");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<RestaurantMenu, RestaurantMenuViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<RestaurantMenu, RestaurantMenuViewHolder>
                        (RestaurantMenu.class, R.layout.menu_row,RestaurantMenuViewHolder.class,mDatabase)

                {
                    @Override
                    protected void populateViewHolder(RestaurantMenuViewHolder viewHolder, RestaurantMenu model, int position) {
    ...
    public static class RestaurantMenuViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setFoodName(String foodName){
            ...
            TextView post_foodname = (TextView) mView.findViewById(R.id.post_foodname);
            post_foodname.setText(foodName);
        }
